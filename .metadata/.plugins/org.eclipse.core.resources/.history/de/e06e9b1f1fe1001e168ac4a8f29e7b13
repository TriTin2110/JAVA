...
public class ShowBorrowDetail extends JFrame {
	...
	public ShowBorrowDetail(ModelBorrowDetail modelBorrowDetail) {
		...
		lblExpiredStatusResult.setForeground(SetAttribute.setColor(expiredStatus));
		...
		String returnStatus = modelBorrowDetail.getReturnStatus();
		JLabel lblReturnStatusResult = new JLabel(returnStatus);
		lblReturnStatusResult.setForeground(SetAttribute.setColor(returnStatus));
