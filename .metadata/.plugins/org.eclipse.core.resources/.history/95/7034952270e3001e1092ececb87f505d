...
public class MainController implements ActionListener {
	...
	public void controllerPeform(ClientMainFrame clientMainFrame, String currentTable) {
		...
		case "Student":
			...
			studentController.getListStudent(clientMainFrame, list);
			break;

		// Tạo bảng sách
		case "Book":
			CreateTable bookController = new CreateTable(clientMainFrame);
			bookController.getListBook(clientMainFrame, list);
			break;

		case "Borrow":
			CreateTable borrowController = new CreateTable(clientMainFrame);
			borrowController.getListBorrow(clientMainFrame, list, mainInterface);
			break;
		}
	...
	private void ImportData() {
		if (this.clientMainFrame.tableChosen.isEmpty()) {
			JOptionPane.showMessageDialog(this.clientMainFrame, "Bạn vui lòng chọn bảng trước!");
		}
		// TODO Auto-generated method stub
		else {
