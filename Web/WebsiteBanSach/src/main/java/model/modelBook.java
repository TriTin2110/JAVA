...
public class modelBook {
	...
	public modelBook(String bookId, String bookName, String language, String desciption, modelTypeOfBook typeOfBook,
			modelAuthor author, int publicYear, int quantity, long importPrice, long price, long outportPrice) {
		this.bookId = bookId;
	...
	public String toString() {
		return "modelBook [bookId=" + bookId + ", bookName=" + bookName + ", language=" + language + ", desciption="
				+ desciption + ", typeOfBook=" + typeOfBook + ", author=" + author + ", publicYear=" + publicYear
				+ ", quantity=" + quantity + ", importPrice=" + importPrice + ", price=" + price + ", outportPrice="
				+ outportPrice + "]";
	}
