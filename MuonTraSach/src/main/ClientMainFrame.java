...
public class ClientMainFrame extends JFrame {
	...
	public Box horizontalBoxTable;
	public Server itemListenerServer;
	...
	public ClientMainFrame() {
		...
		itemListenerServer = new Server(this);
		...
		horizontalBoxTable = Box.createHorizontalBox();
		...
		comboBoxSearching.addItemListener(e -> {
			...
			// Khi thay đổi bảng thì select item sẽ bị null
			...
			if (e.getStateChange() == ItemEvent.SELECTED) {
				if (object != null) {
					...
					// Quay trở về lựa chọn ban đầu sau khi bảng thông tin xuất hiện
					comboBoxSearching.setSelectedIndex(0);
				}
			}
