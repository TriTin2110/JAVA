...
//			String[] column = { "Mã tác giả", "Tên tác giả", "Quốc gia", "Tuổi", "Số điện thoại" };
			...
			clientMainFrame.tableChosen = currentTable;
		} catch (Exception e) {
	...
	public void getListStudent(ClientMainFrame clientMainFrame, ArrayList<Object> list) {
		try {
	...
	public void getListBook(ClientMainFrame clientMainFrame, ArrayList<Object> list) {
		try {
	...
	public void getListBorrow(ClientMainFrame clientMainFrame, ArrayList<Object> list, MainInterface mainInterface) {
		try {
