...
public class MainImp extends UnicastRemoteObject implements MainInterface {
	...
	public String getField(Object object, String currentTable, String method) {
		...
		case "Borrow":
			...
			if (object != null) {
				...
				update = "update BorrowDetail set id_book = '" + income[2] + "', id_student = '" + income[3]
						...
						+ income[6] + "', return_day = '" + income[7] + "' where id_borrow ='" + income[1] + "'";
			}
		...
		String id = (currentTable.equals("Borrow")) ? "borrow" : income[0];
		switch (method) {
		case "Add":
			return add;
		...
		case "Remove":
			...
			return "delete from " + income[0] + " where id_" + id + " = '" + income[1] + "'";
